...
function getUser() {
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#sname').html(result.realname==null?'-':result.realname==''?'-':result.realname);
            $('#depart').html(result.result.departments==null?'-':result.result.departments==''?'-':result.result.departments);
            $('#major').html(result.result.major==null?'-':result.result.major==''?'-':result.result.major);
